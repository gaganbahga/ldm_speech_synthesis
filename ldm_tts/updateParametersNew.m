function LDM_params = updateParametersNew(stats, n, m, FOld,HOld,diagonal)
% similar to update parameters but more closer to the deived formaulae
% did not work any better though 

%diagonal = false;
%FOld = oldParams.F;
%HOld = oldParams.H(:,1:n);
HOld = HOld(:,1:n);
